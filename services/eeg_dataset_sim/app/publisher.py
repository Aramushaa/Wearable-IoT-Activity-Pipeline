"""MQTT publisher for raw EEG dataset samples."""
...
class MqttPublisher:
    """Publish raw EEG rows to the configured MQTT topic."""
    ...
    def build_payload(self, sample: EegSample) -> dict:
        """Convert an EEG sample into the raw MQTT JSON contract."""
        return {
    ...
    def publish_sample(self, sample: EegSample) -> None:
        """Publish one EEG sample and fail if the broker rejects it."""
